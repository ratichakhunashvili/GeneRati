...
export default function ActivityForm({ onAdd }) {
  ...
  return (
    ...
    <form onSubmit={handleSubmit} noValidate className="space-y-4">
      ...
      {/* There is deliberately no design control here. These four fields are
          the entire input to the poster — the generator writes its own prompt
          from them. */}
      <p className="rounded-lg bg-blue-50 p-3 text-sm text-blue-900">
        The poster is generated from these four fields alone. Nothing else to fill in.
      </p>
