...
/**
 * Size uploaded template images are normalised to.
 *
 * 1.5× the page is ~144dpi, which is plenty for something read from across a
 * room, and keeps the base64 copy embedded in every generated poster to a
 * sane weight. A3 has twice the area of A4, so going higher here costs a lot.
 */
export const STORED_WIDTH = Math.round(POSTER_WIDTH * 1.5);
export const STORED_HEIGHT = Math.round(POSTER_HEIGHT * 1.5);
